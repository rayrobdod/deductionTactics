...
import com.rayrobdod.javaScriptObjectNotation.parser.listeners.BoundsJSONParseListener;
import com.rayrobdod.javaScriptObjectNotation.parser.listeners.GetJSONArrayParseListener;
 ...
 */
public class JSONArray extends AbstractSequentialList<Object>
{
...
*/		
	...
	public void add(final int index, final Object o) throws IndexOutOfBoundsException
	{
		...
		BoundsJSONParseListener l = new BoundsJSONParseListener(index);
	...
	public Object get(final int index) throws IndexOutOfBoundsException
	{
		...
		GetJSONArrayParseListener l = new GetJSONArrayParseListener(index); 
			...
			throws ClassCastException, IndexOutOfBoundsException
	{
		...
		String removed = unparsed.substring(l.getElementStartIndex(), l.getElementEndIndex() - 1
				/* -1 to exclude comma */);
		unparsed = unparsed.substring(0, l.getElementStartIndex())
				+ encode(o)
				+ unparsed.substring(l.getElementEndIndex() - 1 /* -1 to include comma */);
