 ...
 */
public class JSONObject extends AbstractMap<JSONString, Object>
{
	...
	public Set<Entry<JSONString, Object>> entrySet()
	{
		class JSONObjectEntrySet extends AbstractSet<Entry<JSONString, Object>>
		{
			public Iterator<Entry<JSONString, Object>> iterator()
			{
